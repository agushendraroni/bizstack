-- BizStack Dummy Data Insert Script
-- Ensures proper relational integrity with TenantId and UserId connections

-- =============================================
-- 1. ORGANIZATION SERVICE - Companies & Structure
-- =============================================

-- Companies (Tenant basis)
INSERT INTO organization_db."Companies" ("Id", "Code", "Name", "Description", "Address", "Phone", "Email", "Website", "CreatedAt", "IsActive", "IsDeleted", "TenantId") VALUES
('11111111-1111-1111-1111-111111111111', 'BLITZ', 'PT Blitz Technology Indonesia', 'Leading business technology solutions', 'Jakarta Selatan', '+62-21-12345678', 'info@blitz.co.id', 'https://blitz.co.id', NOW(), true, false, 1),
('22222222-2222-2222-2222-222222222222', 'DEMO', 'Demo Company Ltd', 'Demo company for testing', 'Bandung', '+62-22-87654321', 'demo@company.com', 'https://demo.com', NOW(), true, false, 2),
('33333333-3333-3333-3333-333333333333', 'BIZSTACK', 'BizStack Corp', 'Business stack solutions', 'Surabaya', '+62-31-11111111', 'hello@bizstack.com', 'https://bizstack.com', NOW(), true, false, 3);
...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin', '$2a$11$rQw8qKqKqKqKqKqKqKqKqO', 0, NOW(), false, '11111111-1111-1111-1111-111111111111', NOW(), true, false, 1, 'system'),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'manager', '$2a$11$rQw8qKqKqKqKqKqKqKqKqO', 0, NOW(), false, '11111111-1111-1111-1111-111111111111', NOW(), true, false, 1, 'admin'),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'demo_user', '$2a$11$rQw8qKqKqKqKqKqKqKqKqO', 0, NOW(), false, '22222222-2222-2222-2222-222222222222', NOW(), true, false, 2, 'system'),
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'bizstack_admin', '$2a$11$rQw8qKqKqKqKqKqKqKqKqO', 0, NOW(), false, '33333333-3333-3333-3333-333333333333', NOW(), true, false, 3, 'system');

-- Roles
INSERT INTO auth_db."Roles" ("Id", "Name", "Description", "CompanyId", "CreatedAt", "IsActive", "IsDeleted", "TenantId", "CreatedBy") VALUES
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Super Admin', 'Full system access', '11111111-1111-1111-1111-111111111111', NOW(), true, false, 1, 'system'),
('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Manager', 'Management access', '11111111-1111-1111-1111-111111111111', NOW(), true, false, 1, 'admin'),
('gggggggg-gggg-gggg-gggg-gggggggggggg', 'Employee', 'Basic employee access', '11111111-1111-1111-1111-111111111111', NOW(), true, false, 1, 'admin'),
('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', 'Demo Admin', 'Demo company admin', '22222222-2222-2222-2222-222222222222', NOW(), true, false, 2, 'system');
...
-- =============================================
-- TenantId 1: BLITZ company with admin, manager users
-- TenantId 2: DEMO company with demo_user
-- TenantId 3: BIZSTACK company with bizstack_admin
-- 
-- All entities properly linked via:
-- - TenantId for multi-tenancy
-- - UserId references between auth-service and user-service
-- - CompanyId linking users to companies
-- - Foreign keys maintaining referential integrity
-- - CreatedBy tracking who created each record
-- =============================================